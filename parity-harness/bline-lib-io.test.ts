...
const tankCases = [
  ...
  {
    name: "gentle acceleration uses relative precision",
    initial: [-Math.sqrt(0.05), Math.sqrt(0.05) / 2],
    request: [-100, Math.sqrt(0.05) / 2],
    limits: [0.05, 1e-8, 100, 100],
    dt: 0.02,
    direction: "backward",
  },
  {
    name: "high acceleration uses absolute precision",
    initial: [Math.sqrt(10), Math.sqrt(10) / 2],
    request: [100, Math.sqrt(10) / 2],
